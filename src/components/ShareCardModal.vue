    ...
    <div class="modal-content share-modal-content">
      ...
      <div id="share-card-node" class="share-card-wrapper">
        <div class="share-card-header">
          ...
          <span class="share-tag">行程规划与路书</span>
        </div>
        ...
        <div class="share-card-footer">
          <div class="share-qrcode-area">
            ...
            <div class="share-tip-text">
              <span class="primary">扫码体验 AI 旅程路线规划与定制路书</span>
...
// 清理回复末尾的特殊标记 [LVCHENG_SCORES]...[/LVCHENG_SCORES]
const cleanContent = computed(() => {
  if (!props.content) return '';
  return props.content.replace(/\[LVCHENG_SCORES\][\s\S]*?\[\/LVCHENG_SCORES\]/gi, '').trim();
});
...
const handleCopy = async () => {
  try {
    const textToCopy = `【网腾无限AI - 旅游规划与行程路书】\n\n${cleanContent.value}\n\n体验定制行程路书大模型：https://ai.wuxian.xyz`;
